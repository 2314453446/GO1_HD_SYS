...
if __name__ == "__main__":
    ...
    #   默认指向根目录下的VOC数据集
    #-------------------------------------------------------#
    VOCdevkit_path  = '../Dataset/bean_240613_line_v1_clip_voc'
    #-------------------------------------------------------#
    #   结果输出的文件夹，默认为map_out
    #-------------------------------------------------------#
    map_out_path    = 'map_output/bean_240613_line_v1_clip'
    ...
    # ---------------------------------------------------
    # map_mod : 5 用于sahi+yolov7的预测结果
    # ---------------------------------------------------
    from sahi.predict import get_sliced_prediction, predict, get_prediction
    from sahi.utils.file import download_from_url
    from sahi import AutoDetectionModel

    yolov7_model_path = 'logs/voc_0608_weed_v4_slice/ep300-loss0.062-val_loss0.073.pth'
    if map_mode == 5:
        print("Load model.")
        ...
        for image_id in tqdm(image_ids):
            ...
            for prediction in result.object_prediction_list:
                ...
                predicted_class = prediction.category.name

                left, top, right, bottom =bbox.minx,bbox.miny,bbox.maxx,bbox.maxy
